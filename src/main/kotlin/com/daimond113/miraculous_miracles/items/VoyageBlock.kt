...
class VoyageBlock :
    ...
    @Deprecated(
        "overriding is fine", ReplaceWith(
            ...
            "com.daimond113.miraculous_miracles.items.VoyageBlock.Companion.FACING"
        )
    )
    ...
    override fun createBlockEntity(pos: BlockPos, state: BlockState): BlockEntity {
        return VoyageBlockEntity(pos, state)
    }
    ...
    override fun onBreak(world: World, pos: BlockPos, state: BlockState, player: PlayerEntity?) {
        if (!world.isClient) {
            ...
            if (downBlockEntity is VoyageBlockEntity) {
    ...
    override fun onEntityCollision(state: BlockState, world: World, pos: BlockPos, entity: Entity) {
        if (!world.isClient && entity.canUsePortals() && !entity.hasNetherPortalCooldown()) {
            ...
            if (destinationEntity is VoyageBlockEntity) {
                destinationEntity.destination?.let {
                    val destinationFacing = world.getBlockState(it).get(FACING)
                    ...
                    if (entity is ServerPlayerEntity) {
                        ...
                        entity.networkHandler.requestTeleport(x, y, z, entity.yaw, entity.pitch)
