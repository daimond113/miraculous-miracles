...
class SpinningTopEntity : ThrownItemEntity {
    constructor(entityType: EntityType<out SpinningTopEntity?>, world: World) : super(entityType, world)

    constructor(world: World, owner: LivingEntity) : super(MiraculousMiracles.BEE_SPINNING_TOP_ENTITY, owner, world)

    override fun getDefaultItem(): Item {
        return MiraculousMiracles.MIRACULOUS_WEAPONS[MiraculousType.Bee]!!
    }
